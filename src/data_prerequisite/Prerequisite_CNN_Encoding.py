...
from src.data_prerequisite.Prerequisite_Function import Encoding, Add_Channel_Dim_With_CWT
...
def process():
    ...
    data_test, out_label_test, data_val, out_label_val, data_train, out_label_train, out_classes_ = Encoding(input_data,
                                                                                                             input_label,
                                                                                                             0.2,
                                                                                                             0.15)
    ...
    return out_classes_, out_data_test_c, out_data_train_c, out_data_val_c, out_label_test, out_label_val, out_label_train
